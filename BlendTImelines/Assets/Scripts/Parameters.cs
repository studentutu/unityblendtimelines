...
public class Parameters
{
    ...
    public static class Keys
    {
        ...
        public static int VelocityX = Animator.StringToHash("VelX");
    ...
    public float Speed
    {
        get { return _animator.GetFloat(Keys.Speed); }
        set { SetDampedFloat(Keys.Speed, value); }
    }
    
    public float VelocityX
    {
        get { return _animator.GetFloat(Keys.VelocityX); }
        set { SetDampedFloat(Keys.VelocityX, value); }
    }
